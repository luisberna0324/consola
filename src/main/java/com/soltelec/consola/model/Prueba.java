...
/**
*
* @author Gerencia Desarrollo de Soluciones Tecnologicas select  db_cda.tipos_medida.`Nombre_medida`,   db_cda.medidas.`Valor_medida` from medidas, tipos_medida  where db_cda.medidas.`TEST` =  
...
public class Prueba implements Serializable {
    ...
    @Column(name = "punto_labrado_repuesto")
    private String puntoLabradoRepuesto;
    ...
    @ManyToOne
    private UsuarioMySql usuarioFor;
    ...
    public Prueba() {
        ...
        this.finalizada = "N";
        this.autorizada = "N";
        this.usuarioFor= new UsuarioMySql();
    }
    ...
    public Prueba(Integer id, Date fecha, int tipopruebafor, int vehiculofor, int propietariofor, UsuarioMySql usuario, HojaPruebas hojaPruebas, String fechaAborto) {
        this.id = id;
        this.fecha = fecha;
    ...
    public UsuarioMySql getUsuarioFor() {
        return usuarioFor;
    }
    ...
    public void setUsuarioFor(UsuarioMySql usuarioFor) {
    ...
    public String getPuntoLabradoRepuesto() {
		return puntoLabradoRepuesto;
	}

	public void setPuntoLabradoRepuesto(String puntoLabradoRepuesto) {
		this.puntoLabradoRepuesto = puntoLabradoRepuesto;
	}
