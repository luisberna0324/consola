...
public class TipoVehiculo implements Serializable {
    ...
    @Column(name = "ctx_busqueda")
    private Integer ctxBusqueda;
    ...
    public Integer getCtxBusqueda() {
		return ctxBusqueda;
	}

	public void setCtxBusqueda(Integer ctxBusqueda) {
		this.ctxBusqueda = ctxBusqueda;
	}
